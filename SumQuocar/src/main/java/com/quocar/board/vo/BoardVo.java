...
public class BoardVo {
	...
	// Constructor
	public BoardVo(int idx, String menu_id, String title, String cont, String writer, Date regdate, int readcount,
			int bnum, int lvl, int step, int nref, int delnum, int parent) {
		super();
		this.idx = idx;
