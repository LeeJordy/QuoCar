...
<body>
	...
	<div class="container">
		<div class="content">
			...
			<div class="card-news">
				<a
					href="https://brunch.co.kr/@hmgjournal/392">
			...
			<div class="card-news">
				<a
					...
					<div class="card-news-content">
						<p>➡ 엔진오일 교체주기</p>
						<div class="card-news-source">
							<img src="/img/kg.png" alt="KG" class="source-icon">
							<span class="source-name">KG 모빌리티</span>
						</div>
					</div>
				</a>
			</div>
			...
			<div class="card-news">
				<a
					href="https://www.hyundai.co.kr/story/CONT0000000000115744">
					<div class="card-news-image">
			...
			<div class="card-news1">
				<a href="https://plan.danawa.com/info/?nPlanSeq=2240">
					...
					<div class="card-news1-content">
						<p>➡ 박병일 자동차명장 유튜브</p>
						<div class="card-news1-source">
							<img src="/img/utube.png" alt="유튜브" class="source-icon1">
							<span class="source-name">유튜브</span>
						</div>
					</div>
				</a>
			</div>
		...
		<div class="content new car">
			...
			<div class="card-news">
				<a
					href="https://www.motoya.co.kr/news/articleView.html?idxno=17974">
					<div class="card-news-image">
			...
			<div class="card-news">
				<a
					...
					<div class="card-news-content">
						...
						<div class="card-news-source">
							<img src="/img/bar.png" alt="바름정비" class="source-icon">
							<span class="source-name">바름정비</span>
						</div>
					</div>
				</a>
			</div>
			...
			<div class="card-news">
				<a
					href="https://www.hyundai.co.kr/story/CONT0000000000072139">
					<div class="card-news-image">
					...
					<div class="card-news-content">
						...
						<div class="card-news-source">
							<img src="/img/hlogo.png" alt="현대" class="source-icon">
							<span class="source-name">현대자동차</span>
						</div>
					</div>
				</a>
		...
		<div class="content new car">
			...
			<div class="card-news">
				<a
					href="https://plan.danawa.com/info/?nPlanSeq=428">
					<div class="card-news-image">
